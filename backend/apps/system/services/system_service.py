...
DEFAULT_SETTINGS = {
    "identity_assurance": {
        ...
        "enable_left_turn": {"value": False, "description": "Allow left turn challenges (enrollment only)"},
        "enable_right_turn": {"value": False, "description": "Allow right turn challenges (enrollment only)"},
