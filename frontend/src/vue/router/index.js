    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "settings-governance-hub",
          component: () => import("@/views/settings/SettingsGovernanceHubView.vue"),
          meta: { title: "Election Governance", roles: ["super_admin"] },
        },
        {
          path: "settings/governance/election-administration",
        ...
        {
          path: "settings/governance/strongroom",
        ...
        {
          path: "settings/governance/platform-defaults",
